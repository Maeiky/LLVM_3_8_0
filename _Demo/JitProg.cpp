...
bool JitProg::fParse(){
    if( oBuff){
      ...
      //  LLVMSetTarget(oModule,"i686-pc-mingw32"); //Overite, we already know our target, to be portable the target was specified here
        LLVMSetTarget(oModule,"i686-pc-mingw32"); //Overite, we already know our target, to be portable the target was specified here
        ...
        //Builder
//LLVMPassManagerBuilderSetOptLevel(llvm::CodeGenOpt::None);
//LLVMPassManagerBuilderSetOptLevel(llvm::CodeGenOpt::None);
/*
        // MCJIT
