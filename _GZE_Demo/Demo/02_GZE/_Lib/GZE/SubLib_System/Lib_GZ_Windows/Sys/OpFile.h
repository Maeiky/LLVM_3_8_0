#if !( defined tHDef_Lib_GZ_Windows_Sys_OpFile || defined  tHDef_IN_Lib_GZ_Sys_File || defined  tHDef_IN_Lib_GZ_Class)
#pragma once
#define tHDef_Lib_GZ_Windows_Sys_OpFile
...
class tApi_Lib_GZ_Windows pOpFile {
...
class tApi_Lib_GZ_Windows cOpFile : public Lib_GZ::Sys::cFile {
...
class tApi_Lib_GZ_Windows csOpFile : public Lib_GZ::Sys::csFile  {
