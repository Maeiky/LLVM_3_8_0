#if !( defined tHDef_Lib_GZ_Windows_Sys_OpSystem || defined  tHDef_IN_Lib_GZ_Sys_System || defined  tHDef_IN_Lib_GZ_Class)
#pragma once
#define tHDef_Lib_GZ_Windows_Sys_OpSystem
#define tHDef_IN_Lib_GZ_Windows_Sys_OpSystem
...
class tApi_Lib_GZ_Windows pOpSystem {
...
class tApi_Lib_GZ_Windows cOpSystem : public Lib_GZ::Sys::cSystem {
...
class tApi_Lib_GZ_Windows csOpSystem : public Lib_GZ::Sys::csSystem  {
...
#undef tHDef_IN_Lib_GZ_Windows_Sys_OpSystem
#endif