#if !( defined tHDef_Lib_GZ_Windows_Sys_OpDebug || defined  tHDef_IN_Lib_GZ_Sys_Debug || defined  tHDef_IN_Lib_GZ_Class)
#pragma once
#define tHDef_Lib_GZ_Windows_Sys_OpDebug
#define tHDef_IN_Lib_GZ_Windows_Sys_OpDebug
...
class tApi_Lib_GZ_Windows pOpDebug {
...
class tApi_Lib_GZ_Windows cOpDebug : public Lib_GZ::Sys::cDebug {
...
class tApi_Lib_GZ_Windows csOpDebug : public Lib_GZ::Sys::csDebug  {
...
#undef tHDef_IN_Lib_GZ_Windows_Sys_OpDebug
#endif